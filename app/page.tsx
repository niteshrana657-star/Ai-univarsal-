...
const capabilities = [
  {
    title: "AI Chat",
    description: "Ask questions, solve problems, plan tasks and get intelligent assistance.",
    icon: "✦",
  },
  {
    title: "Remember",
    description: "Keep useful context, preferences and conversations available across sessions.",
    icon: "🧠",
  },
  {
    title: "Voice Assistant",
    description: "Interact naturally with ChatOne using voice commands and responses.",
    icon: "🎙",
  },
  {
    title: "Screen Understanding",
    description: "Understand what is on your screen when you explicitly grant permission.",
    icon: "👁",
  },
  {
    title: "Automation",
    description: "Plan and assist with repetitive tasks and intelligent workflows.",
    icon: "⚙",
  },
  {
    title: "Permissions",
    description: "Control exactly what ChatOne can access and when it can access it.",
    icon: "✓",
  },
  {
    title: "Security & Privacy",
    description: "Permission-based operation, privacy controls and human override.",
    icon: "🛡",
  },
  {
    title: "Cloud Sync",
    description: "Synchronize supported data and services across connected cloud accounts.",
    icon: "☁",
  },
  {
    title: "Analytics",
    description: "Understand usage, activity and system performance.",
    icon: "📊",
  },
  {
    title: "Plugins",
    description: "Extend ChatOne with new capabilities through a controlled plugin system.",
    icon: "🔌",
  },
];
        ...
        <section className="flex-1 p-4 md:p-8">
          ...
          <section className="mb-8 overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-violet-500/10 via-[#11131b] to-cyan-500/5 p-6 md:p-9">
            ...
            <p className="mt-4 max-w-3xl text-sm leading-6 text-white/50">
              ...
              environment while keeping permissions, privacy and
              human control at the center.
            </p>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              ...
              <button
                onClick={() => setActiveFeature("Voice Assistant")}
